...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.671038689805742, unseen = -5.84354441703136,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 343},
                   koData =
                     ClassData{prior = -0.7157555285875381, unseen = -5.799092654460526,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4927606163683517, unseen = -6.946013991099227,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.251903883165888),
                                    ("Father's Dayyear (latent)", -6.251903883165888),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.251903883165888),
                                    ("Ramadanyear (latent)", -6.251903883165888),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.237000862623624),
                                    ("Bhai Doojyear (latent)", -6.251903883165888),
                                    ("hourday", -4.237000862623624),
                                    ("dayhour", -3.3341331510816095),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.237000862623624),
                                    ("Martin Luther King's Dayyear (latent)", -5.846438775057725),
                                    ("Shemini Atzeretyear (latent)", -6.251903883165888),
                                    ("daymonth", -4.642465970731788),
                                    ("monthday", -5.846438775057725),
                                    ("monthyear", -4.460144413937834),
                                    ("Yom Ha'atzmautyear (latent)", -6.251903883165888),
                                    ("Vijayadashamiyear (latent)", -6.251903883165888),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.846438775057725),
                                    ("Thanksgiving Dayyear (latent)", -5.153291594497779),
                                    ("Thai Pongalyear (latent)", -5.558756702605943),
                                    ("Thiru Onamyear (latent)", -5.558756702605943),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.251903883165888),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.251903883165888),
                                    ("<day-of-month> (ordinal)Wednesday", -6.251903883165888),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.251903883165888),
                                    ("houryear", -5.335613151291733),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.251903883165888),
                                    ("Christmas<time-of-day> am|pm", -6.251903883165888),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.251903883165888),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.558756702605943),
                                    ("intersectin|during <named-month>|year", -6.251903883165888),
                                    ("<time-of-day> am|pmintersect", -4.99914091467052),
                                    ("Earth Houryear (latent)", -6.251903883165888),
                                    ("Family Dayyear (latent)", -5.335613151291733),
                                    ("Octoberyear (latent)", -4.747826486389615),
                                    ("intersect<time-of-day> am|pm", -6.251903883165888),
                                    ("Mattu Pongalyear (latent)", -6.251903883165888),
                                    ("Shavuotyear (latent)", -6.251903883165888),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.251903883165888),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.251903883165888),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.846438775057725),
                                    ("Marchyear (latent)", -6.251903883165888),
                                    ("Sukkotyear (latent)", -5.846438775057725),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.846438775057725),
                                    ("Clean Mondayyear (latent)", -5.846438775057725),
                                    ("monthhour", -5.846438775057725),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.558756702605943),
                                    ("todayat <time-of-day>", -6.251903883165888),
                                    ("Thursday<time> timezone", -4.305993734110575),
                                    ("time-of-day (latent)tonight", -5.846438775057725),
                                    ("from|since|after <time>December", -6.251903883165888),
                                    ("<time-of-day> am|pmon <day>", -4.237000862623624),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.251903883165888),
                                    ("yyyy-mm-ddhh:mm:ss", -5.846438775057725),
                                    ("dayday", -3.809556847796684),
                                    ("<time> <part-of-day>at <time-of-day>", -6.251903883165888),
                                    ("mm/ddat <time-of-day>", -6.251903883165888),
                                    ("tonightat <time-of-day>", -6.251903883165888),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.558756702605943),
                                    ("today<time-of-day> am|pm", -6.251903883165888),
                                    ("Februarythe <day-of-month> (ordinal)", -5.846438775057725),
                                    ("at <time-of-day><time> <part-of-day>", -6.251903883165888),
                                    ("<day-of-month> (ordinal)intersect", -5.846438775057725),
                                    ("mm/dd<time-of-day> am|pm", -6.251903883165888),
                                    ("hourhour", -4.172462341486053),
                                    ("Navaratriin|during <named-month>|year", -6.251903883165888),
                                    ("National Patriots' Dayyear (latent)", -5.558756702605943),
                                    ("Wednesdaythis|last|next <cycle>", -6.251903883165888),
                                    ("Lentyear (latent)", -6.251903883165888),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.747826486389615),
                                    ("Boghiyear (latent)", -6.251903883165888),
                                    ("dayyear", -2.032396177989782),
                                    ("Thursdayfrom|since|after <time>", -5.846438775057725),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.251903883165888),
                                    ("Thursdayat <time-of-day>", -5.558756702605943),
                                    ("Islamic New Yearyear (latent)", -5.846438775057725),
                                    ("Laylat al-Qadryear (latent)", -5.335613151291733),
                                    ("Discovery Dayyear (latent)", -5.846438775057725),
                                    ("Shrove Tuesdayyear (latent)", -6.251903883165888),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.558756702605943),
                                    ("<time-of-day> am|pmtomorrow", -5.558756702605943),
                                    ("Yom Kippuryear (latent)", -6.251903883165888),
                                    ("<day-of-month> (ordinal)Tuesday", -5.846438775057725),
                                    ("<part-of-day> of <time>year (latent)", -6.251903883165888),
                                    ("minutehour", -5.153291594497779),
                                    ("Kaanum Pongalyear (latent)", -5.846438775057725),
                                    ("Maha Saptamiyear (latent)", -6.251903883165888),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.846438775057725),
                                    ("time-of-day (latent)tomorrow", -5.335613151291733),
                                    ("part of daysat <time-of-day>", -5.846438775057725),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.547155790927463),
                                    ("for <duration> from <time>December", -6.251903883165888),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.251903883165888),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.99914091467052),
                                    ("time-of-day (latent)this <part-of-day>", -6.251903883165888),
                                    ("Pentecostyear (latent)", -6.251903883165888),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.99914091467052),
                                    ("<day-of-month> (ordinal)February", -6.251903883165888),
                                    ("Eid al-Fitryear (latent)", -6.251903883165888),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.251903883165888),
                                    ("Mondayin|during the <part-of-day>", -6.251903883165888),
                                    ("Chhathin|during <named-month>|year", -6.251903883165888),
                                    ("Diwaliin|during <named-month>|year", -6.251903883165888),
                                    ("Vaisakhiin|during <named-month>|year", -6.251903883165888),
                                    ("Raksha Bandhanyear (latent)", -6.251903883165888),
                                    ("daysecond", -5.846438775057725),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.846438775057725),
                                    ("Ashurayear (latent)", -6.251903883165888),
                                    ("Tuesdayin|during <named-month>|year", -6.251903883165888),
                                    ("Chinese New Yearyear (latent)", -6.251903883165888),
                                    ("tomorrowintersect", -6.251903883165888),
                                    ("Lag BaOmeryear (latent)", -6.251903883165888),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.251903883165888),
                                    ("Eid al-Adhayear (latent)", -5.335613151291733),
                                    ("intersectin|during the <part-of-day>", -6.251903883165888),
                                    ("Palm Sundayyear (latent)", -6.251903883165888),
                                    ("Christmasat <time-of-day>", -6.251903883165888),
                                    ("Passoveryear (latent)", -6.251903883165888),
                                    ("Lazarus Saturdayyear (latent)", -6.251903883165888),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.251903883165888),
                                    ("Yom HaShoahyear (latent)", -5.846438775057725),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.846438775057725),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.251903883165888),
                                    ("Septemberyear (latent)", -5.846438775057725),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.747826486389615),
                                    ("Halloweenyear (latent)", -6.251903883165888),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.251903883165888),
                                    ("at <time-of-day>intersect", -5.846438775057725),
                                    ("Rosh Hashanahyear (latent)", -5.558756702605943),
                                    ("Dhanterasyear (latent)", -6.251903883165888),
                                    ("Tu BiShvatyear (latent)", -6.251903883165888),
                                    ("<day-of-month> (ordinal)December", -5.558756702605943),
                                    ("Holiyear (latent)", -5.558756702605943),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.251903883165888),
                                    ("Holika Dahanyear (latent)", -5.558756702605943),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.251903883165888),
                                    ("dayminute", -3.3341331510816095),
                                    ("Mawlidyear (latent)", -6.251903883165888),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.846438775057725),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.251903883165888),
                                    ("Jumu'atul-Widayear (latent)", -5.335613151291733),
                                    ("minuteday", -2.423262486676794),
                                    ("absorption of , after named dayintersect",
                                     -6.251903883165888),
                                    ("intersectyear (latent)", -6.251903883165888),
                                    ("Orthodox Easter Sundayyear (latent)", -6.251903883165888),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.251903883165888),
                                    ("Boss's Dayyear (latent)", -5.846438775057725),
                                    ("Global Youth Service Dayyear (latent)", -6.251903883165888),
                                    ("Dhanterasin|during <named-month>|year", -6.251903883165888),
                                    ("Tisha B'Avyear (latent)", -6.251903883165888),
                                    ("Isra and Mi'rajyear (latent)", -5.335613151291733),
                                    ("at <time-of-day>on <day>", -5.153291594497779),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.251903883165888),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.558756702605943),
                                    ("Christmasyear (latent)", -5.846438775057725),
                                    ("Naraka Chaturdashiyear (latent)", -5.846438775057725),
                                    ("Thai Pongalin|during <named-month>|year", -6.251903883165888),
                                    ("dayweek", -6.251903883165888),
                                    ("Easter Sundayyear (latent)", -5.558756702605943),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.642465970731788),
                                    ("Labour Dayyear (latent)", -6.251903883165888),
                                    ("weekyear", -5.153291594497779),
                                    ("hh:mmin|during the <part-of-day>", -5.558756702605943),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.846438775057725),
                                    ("Hanukkahyear (latent)", -5.558756702605943),
                                    ("February<time> <part-of-day>", -6.251903883165888),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.251903883165888),
                                    ("Great Lentyear (latent)", -6.251903883165888),
                                    ("tomorrowat <time-of-day>", -5.558756702605943),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.251903883165888),
                                    ("Vaisakhiyear (latent)", -5.558756702605943),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.251903883165888),
                                    ("last <cycle> of <time>year (latent)", -5.558756702605943),
                                    ("at <time-of-day>tomorrow", -5.846438775057725),
                                    ("tomorrow<time-of-day> am|pm", -6.251903883165888),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.251903883165888),
                                    ("Diwaliyear (latent)", -6.251903883165888),
                                    ("between <time> and <time>on <day>", -4.642465970731788),
                                    ("Black Fridayyear (latent)", -5.846438775057725),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.251903883165888),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.251903883165888),
                                    ("Chhathyear (latent)", -5.846438775057725),
                                    ("Vasant Panchamiyear (latent)", -6.251903883165888),
                                    ("St Patrick's Dayyear (latent)", -6.251903883165888),
                                    ("Thursday<time> (timezone)", -6.251903883165888),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.251903883165888),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.846438775057725),
                                    ("Februaryintersect", -6.251903883165888),
                                    ("Mother's Dayyear (latent)", -6.251903883165888),
                                    ("Simchat Torahyear (latent)", -6.251903883165888),
                                    ("Victoria Dayyear (latent)", -5.846438775057725),
                                    ("minuteyear", -6.251903883165888)],
                               n = 391},
                   koData =
                     ClassData{prior = -0.94401527988901, unseen = -6.626717749249025,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.224194986345801),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.932245187448011),
                                    ("<day-of-month> (ordinal)August", -5.932245187448011),
                                    ("dayhour", -3.258096538021482),
                                    ("<time> timezoneyear (latent)", -5.932245187448011),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.015954455573856),
                                    ("Tuesdayfrom|since|after <time>", -5.932245187448011),
                                    ("daymonth", -3.6809533888415156),
                                    ("monthyear", -4.679482218952643),
                                    ("<time-of-day> am|pmyear (latent)", -5.2390980068880655),
                                    ("Thai Pongalyear (latent)", -5.2390980068880655),
                                    ("intersecthh:mm", -5.932245187448011),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.932245187448011),
                                    ("<day-of-month> (ordinal)Wednesday", -5.932245187448011),
                                    ("houryear", -4.54595082632812),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.932245187448011),
                                    ("<day-of-month> (ordinal)October", -5.932245187448011),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.2390980068880655),
                                    ("<time-of-day> am|pmintersect", -4.679482218952643),
                                    ("Octoberyear (latent)", -5.932245187448011),
                                    ("until <time>on <day>", -5.2390980068880655),
                                    ("time-of-day (latent)intersect", -5.932245187448011),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.2390980068880655),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.932245187448011),
                                    ("hh:mmon <day>", -3.489898152078806),
                                    ("absorption of , after named dayJuly", -5.526780079339846),
                                    ("from|since|after <time>July", -5.932245187448011),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.015954455573856),
                                    ("Clean Mondayyear (latent)", -5.932245187448011),
                                    ("monthhour", -5.932245187448011),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.526780079339846),
                                    ("hourmonth", -4.32280727501391),
                                    ("todayat <time-of-day>", -5.932245187448011),
                                    ("from|since|after <time>December", -5.932245187448011),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.932245187448011),
                                    ("<time-of-day> am|pmon <day>", -4.679482218952643),
                                    ("Mondayyear (latent)", -5.2390980068880655),
                                    ("dayday", -4.54595082632812),
                                    ("mm/ddat <time-of-day>", -5.526780079339846),
                                    ("on <day>September", -5.526780079339846),
                                    ("time-of-day (latent)September", -5.526780079339846),
                                    ("hourhour", -5.932245187448011),
                                    ("time-of-day (latent)on <day>", -3.489898152078806),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.526780079339846),
                                    ("dayyear", -3.041873429551846),
                                    ("Thursdaymm/dd", -5.932245187448011),
                                    ("New Year's Dayyear (latent)", -5.526780079339846),
                                    ("Thursdayfrom|since|after <time>", -4.227497095209586),
                                    ("Thursdayat <time-of-day>", -4.32280727501391),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.932245187448011),
                                    ("Aprilyear (latent)", -5.932245187448011),
                                    ("monthminute", -5.932245187448011),
                                    ("<time-of-day> am|pmtomorrow", -5.932245187448011),
                                    ("Thursdayhh:mm", -5.015954455573856),
                                    ("<day-of-month> (ordinal)Tuesday", -5.526780079339846),
                                    ("minutemonth", -4.1404857182199555),
                                    ("minutehour", -5.932245187448011),
                                    ("Augustyear (latent)", -5.526780079339846),
                                    ("week-endin|during <named-month>|year", -5.932245187448011),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.526780079339846),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.932245187448011),
                                    ("Sundayyear (latent)", -5.015954455573856),
                                    ("Christmasat <time-of-day>", -5.932245187448011),
                                    ("from|since|after <time>year (latent)", -4.833632898779901),
                                    ("<duration> after|before|from <time>December",
                                     -5.932245187448011),
                                    ("yesterday<time-of-day> am|pm", -5.932245187448011),
                                    ("<day-of-month> (ordinal)July", -5.932245187448011),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.932245187448011),
                                    ("mm/ddyear (latent)", -5.932245187448011),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.932245187448011),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.932245187448011),
                                    ("at <time-of-day>intersect", -5.526780079339846),
                                    ("hh:mmyear (latent)", -3.8528036457681747),
                                    ("Holiyear (latent)", -5.932245187448011),
                                    ("until <time><time-of-day> am|pm", -5.932245187448011),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.932245187448011),
                                    ("dayminute", -3.367295829986474),
                                    ("yyyy-mm-ddhh:mm", -5.526780079339846),
                                    ("intersectSeptember", -4.428167790671737),
                                    ("minuteday", -2.69356673528363),
                                    ("absorption of , after named dayintersect",
                                     -5.932245187448011),
                                    ("intersectyear (latent)", -5.932245187448011),
                                    ("Februaryin|during the <part-of-day>", -5.932245187448011),
                                    ("time-of-day (latent)July", -5.932245187448011),
                                    ("Saturdayyear (latent)", -5.932245187448011),
                                    ("at <time-of-day>on <day>", -5.526780079339846),
                                    ("absorption of , after named daySeptember",
                                     -5.015954455573856),
                                    ("Naraka Chaturdashiyear (latent)", -5.932245187448011),
                                    ("from|since|after <time>on <day>", -5.015954455573856),
                                    ("dayweek", -5.932245187448011),
                                    ("Easter Sundayyear (latent)", -5.526780079339846),
                                    ("Thursday<time-of-day> am|pm", -4.679482218952643),
                                    ("weekyear", -5.526780079339846),
                                    ("time-of-day (latent)Thursday", -5.526780079339846),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.932245187448011),
                                    ("<day-of-month> (ordinal)April", -5.932245187448011),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.526780079339846),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.2390980068880655),
                                    ("Sundayfrom|since|after <time>", -5.932245187448011),
                                    ("absorption of , after named dayFebruary", -5.015954455573856),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.932245187448011),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.932245187448011),
                                    ("tomorrowat <time-of-day>", -5.932245187448011),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.932245187448011),
                                    ("last <cycle> of <time>year (latent)", -5.526780079339846),
                                    ("tomorrow<time-of-day> am|pm", -5.932245187448011),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.2390980068880655),
                                    ("Diwaliyear (latent)", -5.526780079339846),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.932245187448011),
                                    ("Fridayyear (latent)", -5.526780079339846),
                                    ("time-of-day (latent)April", -5.932245187448011),
                                    ("minuteyear", -3.7350206101117913)],
                               n = 249}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.19671029424605427,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.70412716803491e-2),
                                    ("intersect 2 numbers", -3.71965111278069)],
                               n = 161},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                    ...
                                    ("Black Fridaythis|last|next <cycle>", -4.350277936359301),
                                    ("Labour Daythis|last|next <cycle>", -4.350277936359301),
                                    ...
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -3.9448128282511368),
                                    ("intersectOctober", -3.9448128282511368),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.4339872044851463),
                                    ...
                                    ("on <day><time-of-day> am|pm", -4.350277936359301),
                                    ("intersectintersect", -4.350277936359301),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.085976312551584),
                                    ...
                                    ("on <day>September", -3.6805112044434196),
                                    ...
                                    ("intersectOctober", -4.085976312551584),
                                    ("dayminute", -4.085976312551584),
                                    ("SaturdaySeptember", -4.085976312551584),
                                    ("intersectSeptember", -2.987364023883474),
