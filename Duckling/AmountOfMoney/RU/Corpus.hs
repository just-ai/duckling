...
allExamples = concat
  ...
  , examples (simple Dollar 20.43)
             ...
             , "20 долларами 43 цента"
             , "20 долларами и 43 цента"
             , "двадцать долларов и 43ц"
             ]
  , examples (simple RUB 20.43)
             [ "₽20 и 43к"
             , "20 рублей и 43к"
             , "20 рублей 43 копейки"
             , "20 руб. и 43 коп."
             , "двадцать рублей и сорок три коп."
             , "20руб 43к."
             , "20руб 43к"
             ]
  , examples (simple RUB 1.50)
             [ "1 рубль и 50 копеек"
             , "1 руб. 50 коп."
             , "1 руб. 50коп."
             , "1 руб. 50к."
