...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6826128468749858, unseen = -5.817111159963204,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 334},
                   koData =
                     ClassData{prior = -0.7037936689544328, unseen = -5.796057750765372,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.503960003980009, unseen = -6.916715020353609,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.222576268071369),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.222576268071369),
                                    ("Ramadanyear (latent)", -6.222576268071369),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.207673247529104),
                                    ("Bhai Doojyear (latent)", -6.222576268071369),
                                    ("hourday", -4.207673247529104),
                                    ("dayhour", -3.3048055359870894),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.207673247529104),
                                    ("Martin Luther King's Dayyear (latent)", -5.817111159963204),
                                    ("Shemini Atzeretyear (latent)", -6.222576268071369),
                                    ("daymonth", -4.430816798843313),
                                    ("monthday", -5.817111159963204),
                                    ("monthyear", -4.350774091169777),
                                    ("Yom Ha'atzmautyear (latent)", -6.222576268071369),
                                    ("Vijayadashamiyear (latent)", -6.222576268071369),
                                    ("Thanksgiving Dayyear (latent)", -5.123963979403259),
                                    ("Thai Pongalyear (latent)", -5.529429087511423),
                                    ("Thiru Onamyear (latent)", -5.529429087511423),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.222576268071369),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.222576268071369),
                                    ("<day-of-month> (ordinal)Wednesday", -6.222576268071369),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.222576268071369),
                                    ("houryear", -5.306285536197214),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.222576268071369),
                                    ("Christmas<time-of-day> am|pm", -6.222576268071369),
                                    ("<day-of-month> (ordinal)October", -6.222576268071369),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.222576268071369),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.529429087511423),
                                    ("intersectin|during <named-month>|year", -6.222576268071369),
                                    ("<time-of-day> am|pmintersect", -4.969813299576001),
                                    ("Earth Houryear (latent)", -6.222576268071369),
                                    ("Octoberyear (latent)", -4.613138355637268),
                                    ("intersect<time-of-day> am|pm", -6.222576268071369),
                                    ("Mattu Pongalyear (latent)", -6.222576268071369),
                                    ("Shavuotyear (latent)", -6.222576268071369),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.222576268071369),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.222576268071369),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.817111159963204),
                                    ("Marchyear (latent)", -6.222576268071369),
                                    ("Sukkotyear (latent)", -5.817111159963204),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.817111159963204),
                                    ("Clean Mondayyear (latent)", -5.817111159963204),
                                    ("monthhour", -5.817111159963204),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.529429087511423),
                                    ("todayat <time-of-day>", -6.222576268071369),
                                    ("Thursday<time> timezone", -4.276666119016055),
                                    ("time-of-day (latent)tonight", -5.817111159963204),
                                    ("from|since|after <time>December", -6.222576268071369),
                                    ("<time-of-day> am|pmon <day>", -4.207673247529104),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.222576268071369),
                                    ("yyyy-mm-ddhh:mm:ss", -5.817111159963204),
                                    ("dayday", -3.7802292327021645),
                                    ("<time> <part-of-day>at <time-of-day>", -6.222576268071369),
                                    ("mm/ddat <time-of-day>", -6.222576268071369),
                                    ("tonightat <time-of-day>", -6.222576268071369),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.529429087511423),
                                    ("today<time-of-day> am|pm", -6.222576268071369),
                                    ("Februarythe <day-of-month> (ordinal)", -5.817111159963204),
                                    ("at <time-of-day><time> <part-of-day>", -6.222576268071369),
                                    ("<day-of-month> (ordinal)intersect", -5.529429087511423),
                                    ("mm/dd<time-of-day> am|pm", -6.222576268071369),
                                    ("hourhour", -4.143134726391533),
                                    ("Navaratriin|during <named-month>|year", -6.222576268071369),
                                    ("Wednesdaythis|last|next <cycle>", -6.222576268071369),
                                    ("Lentyear (latent)", -6.222576268071369),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.718498871295094),
                                    ("Boghiyear (latent)", -6.222576268071369),
                                    ("dayyear", -2.1117024038980574),
                                    ("Thursdayfrom|since|after <time>", -5.817111159963204),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.222576268071369),
                                    ("Thursdayat <time-of-day>", -5.529429087511423),
                                    ("Islamic New Yearyear (latent)", -5.817111159963204),
                                    ("Laylat al-Qadryear (latent)", -5.306285536197214),
                                    ("Shrove Tuesdayyear (latent)", -6.222576268071369),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.529429087511423),
                                    ("<time-of-day> am|pmtomorrow", -5.529429087511423),
                                    ("Yom Kippuryear (latent)", -6.222576268071369),
                                    ("<day-of-month> (ordinal)Tuesday", -5.817111159963204),
                                    ("<part-of-day> of <time>year (latent)", -6.222576268071369),
                                    ("minutehour", -5.123963979403259),
                                    ("Kaanum Pongalyear (latent)", -5.817111159963204),
                                    ("Maha Saptamiyear (latent)", -6.222576268071369),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.817111159963204),
                                    ("time-of-day (latent)tomorrow", -5.306285536197214),
                                    ("part of daysat <time-of-day>", -5.817111159963204),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.5178281758329435),
                                    ("for <duration> from <time>December", -6.222576268071369),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.222576268071369),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.969813299576001),
                                    ("time-of-day (latent)this <part-of-day>", -6.222576268071369),
                                    ("Pentecostyear (latent)", -6.222576268071369),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.969813299576001),
                                    ("<day-of-month> (ordinal)February", -6.222576268071369),
                                    ("Eid al-Fitryear (latent)", -6.222576268071369),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.222576268071369),
                                    ("Mondayin|during the <part-of-day>", -6.222576268071369),
                                    ("Chhathin|during <named-month>|year", -6.222576268071369),
                                    ("Diwaliin|during <named-month>|year", -6.222576268071369),
                                    ("Vaisakhiin|during <named-month>|year", -6.222576268071369),
                                    ("Raksha Bandhanyear (latent)", -6.222576268071369),
                                    ("daysecond", -5.817111159963204),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.817111159963204),
                                    ("Ashurayear (latent)", -6.222576268071369),
                                    ("Tuesdayin|during <named-month>|year", -6.222576268071369),
                                    ("Chinese New Yearyear (latent)", -6.222576268071369),
                                    ("tomorrowintersect", -6.222576268071369),
                                    ("Lag BaOmeryear (latent)", -6.222576268071369),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.222576268071369),
                                    ("Eid al-Adhayear (latent)", -5.306285536197214),
                                    ("intersectin|during the <part-of-day>", -6.222576268071369),
                                    ("Palm Sundayyear (latent)", -6.222576268071369),
                                    ("Christmasat <time-of-day>", -6.222576268071369),
                                    ("Passoveryear (latent)", -6.222576268071369),
                                    ("Lazarus Saturdayyear (latent)", -6.222576268071369),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.817111159963204),
                                    ("Yom HaShoahyear (latent)", -5.817111159963204),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.817111159963204),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.222576268071369),
                                    ("Septemberyear (latent)", -5.817111159963204),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.718498871295094),
                                    ("Halloweenyear (latent)", -6.222576268071369),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.222576268071369),
                                    ("at <time-of-day>intersect", -5.817111159963204),
                                    ("Rosh Hashanahyear (latent)", -5.529429087511423),
                                    ("Dhanterasyear (latent)", -6.222576268071369),
                                    ("Tu BiShvatyear (latent)", -6.222576268071369),
                                    ("<day-of-month> (ordinal)December", -5.529429087511423),
                                    ("Holiyear (latent)", -5.529429087511423),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.222576268071369),
                                    ("Holika Dahanyear (latent)", -5.529429087511423),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.222576268071369),
                                    ("dayminute", -3.3048055359870894),
                                    ("Mawlidyear (latent)", -6.222576268071369),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.817111159963204),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.222576268071369),
                                    ("Jumu'atul-Widayear (latent)", -5.306285536197214),
                                    ("minuteday", -2.3939348715822737),
                                    ("absorption of , after named dayintersect",
                                     -6.222576268071369),
                                    ("intersectyear (latent)", -5.817111159963204),
                                    ("Orthodox Easter Sundayyear (latent)", -6.222576268071369),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.222576268071369),
                                    ("Boss's Dayyear (latent)", -5.817111159963204),
                                    ("Global Youth Service Dayyear (latent)", -6.222576268071369),
                                    ("Dhanterasin|during <named-month>|year", -6.222576268071369),
                                    ("Tisha B'Avyear (latent)", -6.222576268071369),
                                    ("Isra and Mi'rajyear (latent)", -5.306285536197214),
                                    ("at <time-of-day>on <day>", -5.123963979403259),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.222576268071369),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.529429087511423),
                                    ("Christmasyear (latent)", -5.817111159963204),
                                    ("Naraka Chaturdashiyear (latent)", -5.817111159963204),
                                    ("Thai Pongalin|during <named-month>|year", -6.222576268071369),
                                    ("dayweek", -6.222576268071369),
                                    ("Easter Sundayyear (latent)", -5.529429087511423),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.613138355637268),
                                    ("weekyear", -5.123963979403259),
                                    ("hh:mmin|during the <part-of-day>", -5.529429087511423),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.817111159963204),
                                    ("Hanukkahyear (latent)", -5.529429087511423),
                                    ("February<time> <part-of-day>", -6.222576268071369),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.222576268071369),
                                    ("Great Lentyear (latent)", -6.222576268071369),
                                    ("tomorrowat <time-of-day>", -5.529429087511423),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.222576268071369),
                                    ("Vaisakhiyear (latent)", -5.529429087511423),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.222576268071369),
                                    ("last <cycle> of <time>year (latent)", -5.529429087511423),
                                    ("at <time-of-day>tomorrow", -5.817111159963204),
                                    ("tomorrow<time-of-day> am|pm", -6.222576268071369),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.222576268071369),
                                    ("Diwaliyear (latent)", -6.222576268071369),
                                    ("between <time> and <time>on <day>", -4.613138355637268),
                                    ("Black Fridayyear (latent)", -5.817111159963204),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.222576268071369),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.222576268071369),
                                    ("Chhathyear (latent)", -5.817111159963204),
                                    ("Vasant Panchamiyear (latent)", -6.222576268071369),
                                    ("St Patrick's Dayyear (latent)", -6.222576268071369),
                                    ("Thursday<time> (timezone)", -6.222576268071369),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.222576268071369),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.817111159963204),
                                    ("Februaryintersect", -6.222576268071369),
                                    ("Simchat Torahyear (latent)", -6.222576268071369),
                                    ("minuteyear", -6.222576268071369)],
                               n = 380},
                   koData =
                     ClassData{prior = -0.9266783602357329, unseen = -6.616065185132817,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.2135282185416054),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.921578419643816),
                                    ("<day-of-month> (ordinal)August", -5.921578419643816),
                                    ("dayhour", -3.2474297702172867),
                                    ("<time> timezoneyear (latent)", -5.921578419643816),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.005287687769661),
                                    ("Tuesdayfrom|since|after <time>", -5.921578419643816),
                                    ("daymonth", -3.6702866210373206),
                                    ("monthyear", -4.668815451148448),
                                    ("<time-of-day> am|pmyear (latent)", -5.2284312390838705),
                                    ("Thai Pongalyear (latent)", -5.2284312390838705),
                                    ("intersecthh:mm", -5.921578419643816),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.921578419643816),
                                    ("<day-of-month> (ordinal)Wednesday", -5.921578419643816),
                                    ("houryear", -4.535284058523925),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.921578419643816),
                                    ("<day-of-month> (ordinal)October", -5.921578419643816),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.2284312390838705),
                                    ("<time-of-day> am|pmintersect", -4.668815451148448),
                                    ("Octoberyear (latent)", -5.921578419643816),
                                    ("until <time>on <day>", -5.2284312390838705),
                                    ("time-of-day (latent)intersect", -5.921578419643816),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.2284312390838705),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.921578419643816),
                                    ("hh:mmon <day>", -3.479231384274611),
                                    ("absorption of , after named dayJuly", -5.516113311535651),
                                    ("from|since|after <time>July", -5.921578419643816),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.005287687769661),
                                    ("Clean Mondayyear (latent)", -5.921578419643816),
                                    ("monthhour", -5.921578419643816),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.516113311535651),
                                    ("hourmonth", -4.312140507209715),
                                    ("todayat <time-of-day>", -5.921578419643816),
                                    ("from|since|after <time>December", -5.921578419643816),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.921578419643816),
                                    ("<time-of-day> am|pmon <day>", -4.668815451148448),
                                    ("Mondayyear (latent)", -5.2284312390838705),
                                    ("dayday", -4.535284058523925),
                                    ("mm/ddat <time-of-day>", -5.516113311535651),
                                    ("on <day>September", -5.516113311535651),
                                    ("time-of-day (latent)September", -5.516113311535651),
                                    ("hourhour", -5.921578419643816),
                                    ("time-of-day (latent)on <day>", -3.479231384274611),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.516113311535651),
                                    ("dayyear", -3.031206661747651),
                                    ("Thursdaymm/dd", -5.921578419643816),
                                    ("New Year's Dayyear (latent)", -5.516113311535651),
                                    ("Thursdayfrom|since|after <time>", -4.216830327405391),
                                    ("Thursdayat <time-of-day>", -4.312140507209715),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.921578419643816),
                                    ("Aprilyear (latent)", -5.921578419643816),
                                    ("monthminute", -5.921578419643816),
                                    ("<time-of-day> am|pmtomorrow", -5.921578419643816),
                                    ("Thursdayhh:mm", -5.005287687769661),
                                    ("<day-of-month> (ordinal)Tuesday", -5.516113311535651),
                                    ("minutemonth", -4.1298189504157605),
                                    ("minutehour", -5.921578419643816),
                                    ("Augustyear (latent)", -5.516113311535651),
                                    ("week-endin|during <named-month>|year", -5.921578419643816),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.516113311535651),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.921578419643816),
                                    ("Sundayyear (latent)", -5.005287687769661),
                                    ("Christmasat <time-of-day>", -5.921578419643816),
                                    ("from|since|after <time>year (latent)", -4.822966130975706),
                                    ("<duration> after|before|from <time>December",
                                     -5.921578419643816),
                                    ("yesterday<time-of-day> am|pm", -5.921578419643816),
                                    ("<day-of-month> (ordinal)July", -5.921578419643816),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.921578419643816),
                                    ("mm/ddyear (latent)", -5.921578419643816),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.921578419643816),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.921578419643816),
                                    ("at <time-of-day>intersect", -5.516113311535651),
                                    ("hh:mmyear (latent)", -3.8421368779639797),
                                    ("Holiyear (latent)", -5.921578419643816),
                                    ("until <time><time-of-day> am|pm", -5.921578419643816),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.921578419643816),
                                    ("dayminute", -3.3566290621822787),
                                    ("yyyy-mm-ddhh:mm", -5.516113311535651),
                                    ("intersectSeptember", -4.417501022867541),
                                    ("minuteday", -2.682899967479435),
                                    ("absorption of , after named dayintersect",
                                     -5.921578419643816),
                                    ("intersectyear (latent)", -5.921578419643816),
                                    ("Februaryin|during the <part-of-day>", -5.921578419643816),
                                    ("time-of-day (latent)July", -5.921578419643816),
                                    ("Saturdayyear (latent)", -5.921578419643816),
                                    ("at <time-of-day>on <day>", -5.516113311535651),
                                    ("absorption of , after named daySeptember",
                                     -5.005287687769661),
                                    ("Naraka Chaturdashiyear (latent)", -5.921578419643816),
                                    ("from|since|after <time>on <day>", -5.005287687769661),
                                    ("dayweek", -5.921578419643816),
                                    ("Easter Sundayyear (latent)", -5.516113311535651),
                                    ("Thursday<time-of-day> am|pm", -4.668815451148448),
                                    ("weekyear", -5.516113311535651),
                                    ("time-of-day (latent)Thursday", -5.516113311535651),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.921578419643816),
                                    ("<day-of-month> (ordinal)April", -5.921578419643816),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.516113311535651),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.2284312390838705),
                                    ("Sundayfrom|since|after <time>", -5.921578419643816),
                                    ("absorption of , after named dayFebruary", -5.005287687769661),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.921578419643816),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.921578419643816),
                                    ("tomorrowat <time-of-day>", -5.921578419643816),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.921578419643816),
                                    ("last <cycle> of <time>year (latent)", -5.516113311535651),
                                    ("tomorrow<time-of-day> am|pm", -5.921578419643816),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.2284312390838705),
                                    ("Diwaliyear (latent)", -5.516113311535651),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.921578419643816),
                                    ("Fridayyear (latent)", -5.516113311535651),
                                    ("time-of-day (latent)April", -5.921578419643816),
                                    ("minuteyear", -3.7243538423075964)],
                               n = 249}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.21489040955748925,
                               ...
                               n = 146},
                   koData =
                     ClassData{prior = -1.6431489697764121,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
