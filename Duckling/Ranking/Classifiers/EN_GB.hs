...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453, unseen = -5.814130531825066,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5171050792508339, unseen = -6.926577033222725,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.2324480165505225),
                                    ("Father's Dayyear (latent)", -6.2324480165505225),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.2324480165505225),
                                    ("Ramadanyear (latent)", -6.2324480165505225),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.217544996008258),
                                    ("Bhai Doojyear (latent)", -6.2324480165505225),
                                    ("hourday", -4.217544996008258),
                                    ("dayhour", -3.3146772844662435),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.217544996008258),
                                    ("Martin Luther King's Dayyear (latent)", -5.826982908442359),
                                    ("Shemini Atzeretyear (latent)", -6.2324480165505225),
                                    ("daymonth", -4.623010104116422),
                                    ("monthday", -5.826982908442359),
                                    ("monthyear", -4.440688547322468),
                                    ("Yom Ha'atzmautyear (latent)", -6.2324480165505225),
                                    ("Vijayadashamiyear (latent)", -6.2324480165505225),
                                    ("Thanksgiving Dayyear (latent)", -5.133835727882413),
                                    ("Thai Pongalyear (latent)", -5.539300835990577),
                                    ("Thiru Onamyear (latent)", -5.539300835990577),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.2324480165505225),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.2324480165505225),
                                    ("<day-of-month> (ordinal)Wednesday", -6.2324480165505225),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.2324480165505225),
                                    ("houryear", -5.316157284676367),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.2324480165505225),
                                    ("Christmas<time-of-day> am|pm", -6.2324480165505225),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.2324480165505225),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.539300835990577),
                                    ("intersectin|during <named-month>|year", -6.2324480165505225),
                                    ("<time-of-day> am|pmintersect", -4.979685048055154),
                                    ("Earth Houryear (latent)", -6.2324480165505225),
                                    ("Octoberyear (latent)", -4.728370619774249),
                                    ("intersect<time-of-day> am|pm", -6.2324480165505225),
                                    ("Mattu Pongalyear (latent)", -6.2324480165505225),
                                    ("Shavuotyear (latent)", -6.2324480165505225),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.2324480165505225),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.2324480165505225),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.826982908442359),
                                    ("Marchyear (latent)", -6.2324480165505225),
                                    ("Sukkotyear (latent)", -5.826982908442359),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.826982908442359),
                                    ("Clean Mondayyear (latent)", -5.826982908442359),
                                    ("monthhour", -5.826982908442359),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.539300835990577),
                                    ("todayat <time-of-day>", -6.2324480165505225),
                                    ("Thursday<time> timezone", -4.286537867495209),
                                    ("time-of-day (latent)tonight", -5.826982908442359),
                                    ("from|since|after <time>December", -6.2324480165505225),
                                    ("dd/mm<time-of-day> am|pm", -6.2324480165505225),
                                    ("<time-of-day> am|pmon <day>", -4.217544996008258),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.2324480165505225),
                                    ("yyyy-mm-ddhh:mm:ss", -5.826982908442359),
                                    ("dayday", -3.790100981181318),
                                    ("dd/mmat <time-of-day>", -6.2324480165505225),
                                    ("<time> <part-of-day>at <time-of-day>", -6.2324480165505225),
                                    ("tonightat <time-of-day>", -6.2324480165505225),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.539300835990577),
                                    ("today<time-of-day> am|pm", -6.2324480165505225),
                                    ("Februarythe <day-of-month> (ordinal)", -5.826982908442359),
                                    ("at <time-of-day><time> <part-of-day>", -6.2324480165505225),
                                    ("<day-of-month> (ordinal)intersect", -5.826982908442359),
                                    ("hourhour", -4.153006474870687),
                                    ("Navaratriin|during <named-month>|year", -6.2324480165505225),
                                    ("Wednesdaythis|last|next <cycle>", -6.2324480165505225),
                                    ("Lentyear (latent)", -6.2324480165505225),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.728370619774249),
                                    ("Boghiyear (latent)", -6.2324480165505225),
                                    ("dayyear", -2.08931329015899),
                                    ("Thursdayfrom|since|after <time>", -5.826982908442359),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.2324480165505225),
                                    ("Thursdayat <time-of-day>", -5.539300835990577),
                                    ("Islamic New Yearyear (latent)", -5.826982908442359),
                                    ("Laylat al-Qadryear (latent)", -5.316157284676367),
                                    ("Shrove Tuesdayyear (latent)", -6.2324480165505225),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.539300835990577),
                                    ("<time-of-day> am|pmtomorrow", -5.539300835990577),
                                    ("Yom Kippuryear (latent)", -6.2324480165505225),
                                    ("<day-of-month> (ordinal)Tuesday", -5.826982908442359),
                                    ("<part-of-day> of <time>year (latent)", -6.2324480165505225),
                                    ("minutehour", -5.133835727882413),
                                    ("Kaanum Pongalyear (latent)", -5.826982908442359),
                                    ("Maha Saptamiyear (latent)", -6.2324480165505225),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.826982908442359),
                                    ("time-of-day (latent)tomorrow", -5.316157284676367),
                                    ("part of daysat <time-of-day>", -5.826982908442359),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.527699924312097),
                                    ("for <duration> from <time>December", -6.2324480165505225),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.2324480165505225),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.979685048055154),
                                    ("time-of-day (latent)this <part-of-day>", -6.2324480165505225),
                                    ("Pentecostyear (latent)", -6.2324480165505225),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.979685048055154),
                                    ("<day-of-month> (ordinal)February", -6.2324480165505225),
                                    ("Eid al-Fitryear (latent)", -6.2324480165505225),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.2324480165505225),
                                    ("Mondayin|during the <part-of-day>", -6.2324480165505225),
                                    ("Chhathin|during <named-month>|year", -6.2324480165505225),
                                    ("Diwaliin|during <named-month>|year", -6.2324480165505225),
                                    ("Vaisakhiin|during <named-month>|year", -6.2324480165505225),
                                    ("Raksha Bandhanyear (latent)", -6.2324480165505225),
                                    ("daysecond", -5.826982908442359),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.826982908442359),
                                    ("Ashurayear (latent)", -6.2324480165505225),
                                    ("Tuesdayin|during <named-month>|year", -6.2324480165505225),
                                    ("Chinese New Yearyear (latent)", -6.2324480165505225),
                                    ("tomorrowintersect", -6.2324480165505225),
                                    ("Lag BaOmeryear (latent)", -6.2324480165505225),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.2324480165505225),
                                    ("Eid al-Adhayear (latent)", -5.316157284676367),
                                    ("intersectin|during the <part-of-day>", -6.2324480165505225),
                                    ("Palm Sundayyear (latent)", -6.2324480165505225),
                                    ("Christmasat <time-of-day>", -6.2324480165505225),
                                    ("Passoveryear (latent)", -6.2324480165505225),
                                    ("Lazarus Saturdayyear (latent)", -6.2324480165505225),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.2324480165505225),
                                    ("Yom HaShoahyear (latent)", -5.826982908442359),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.826982908442359),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.2324480165505225),
                                    ("Septemberyear (latent)", -5.826982908442359),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.728370619774249),
                                    ("Halloweenyear (latent)", -6.2324480165505225),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.2324480165505225),
                                    ("at <time-of-day>intersect", -5.826982908442359),
                                    ("Rosh Hashanahyear (latent)", -5.539300835990577),
                                    ("Dhanterasyear (latent)", -6.2324480165505225),
                                    ("Tu BiShvatyear (latent)", -6.2324480165505225),
                                    ("<day-of-month> (ordinal)December", -5.539300835990577),
                                    ("Holiyear (latent)", -5.539300835990577),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.2324480165505225),
                                    ("Holika Dahanyear (latent)", -5.539300835990577),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.2324480165505225),
                                    ("dayminute", -3.3146772844662435),
                                    ("Mawlidyear (latent)", -6.2324480165505225),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.826982908442359),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.2324480165505225),
                                    ("Jumu'atul-Widayear (latent)", -5.316157284676367),
                                    ("minuteday", -2.403806620061428),
                                    ("absorption of , after named dayintersect",
                                     -6.2324480165505225),
                                    ("intersectyear (latent)", -6.2324480165505225),
                                    ("Orthodox Easter Sundayyear (latent)", -6.2324480165505225),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.2324480165505225),
                                    ("Mothering Sundayyear (latent)", -5.826982908442359),
                                    ("Boss's Dayyear (latent)", -5.826982908442359),
                                    ("Global Youth Service Dayyear (latent)", -6.2324480165505225),
                                    ("Dhanterasin|during <named-month>|year", -6.2324480165505225),
                                    ("Tisha B'Avyear (latent)", -6.2324480165505225),
                                    ("Isra and Mi'rajyear (latent)", -5.316157284676367),
                                    ("at <time-of-day>on <day>", -5.133835727882413),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.2324480165505225),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.539300835990577),
                                    ("Christmasyear (latent)", -5.826982908442359),
                                    ("Naraka Chaturdashiyear (latent)", -5.826982908442359),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.2324480165505225),
                                    ("dayweek", -6.2324480165505225),
                                    ("Easter Sundayyear (latent)", -5.539300835990577),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.623010104116422),
                                    ("weekyear", -5.133835727882413),
                                    ("hh:mmin|during the <part-of-day>", -5.539300835990577),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.826982908442359),
                                    ("Hanukkahyear (latent)", -5.539300835990577),
                                    ("February<time> <part-of-day>", -6.2324480165505225),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.2324480165505225),
                                    ("Great Lentyear (latent)", -6.2324480165505225),
                                    ("tomorrowat <time-of-day>", -5.539300835990577),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.2324480165505225),
                                    ("Vaisakhiyear (latent)", -5.539300835990577),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.2324480165505225),
                                    ("last <cycle> of <time>year (latent)", -5.539300835990577),
                                    ("at <time-of-day>tomorrow", -5.826982908442359),
                                    ("tomorrow<time-of-day> am|pm", -6.2324480165505225),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.2324480165505225),
                                    ("Diwaliyear (latent)", -6.2324480165505225),
                                    ("between <time> and <time>on <day>", -4.623010104116422),
                                    ("Black Fridayyear (latent)", -5.826982908442359),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.2324480165505225),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.2324480165505225),
                                    ("Chhathyear (latent)", -5.826982908442359),
                                    ("Vasant Panchamiyear (latent)", -6.2324480165505225),
                                    ("St Patrick's Dayyear (latent)", -6.2324480165505225),
                                    ("Thursday<time> (timezone)", -6.2324480165505225),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.2324480165505225),
                                    ("August Bank Holidayyear (latent)", -5.539300835990577),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.826982908442359),
                                    ("Februaryintersect", -6.2324480165505225),
                                    ("Simchat Torahyear (latent)", -6.2324480165505225),
                                    ("minuteyear", -6.2324480165505225)],
                               n = 381},
                   koData =
                     ClassData{prior = -0.9069448694559173,
                               unseen = -6.6502790485874215,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.550372261356666),
                                    ("hourday", -3.247787168362621),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.955837369464831),
                                    ("<day-of-month> (ordinal)August", -5.955837369464831),
                                    ("dayhour", -3.2816887200383023),
                                    ("<time> timezoneyear (latent)", -5.955837369464831),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.039546637590676),
                                    ("Tuesdayfrom|since|after <time>", -5.955837369464831),
                                    ("daymonth", -3.7045455708583357),
                                    ("monthyear", -4.703074400969463),
                                    ("<time-of-day> am|pmyear (latent)", -5.262690188904886),
                                    ("Thai Pongalyear (latent)", -5.262690188904886),
                                    ("intersecthh:mm", -5.955837369464831),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.955837369464831),
                                    ("<day-of-month> (ordinal)Wednesday", -5.955837369464831),
                                    ("houryear", -4.56954300834494),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.955837369464831),
                                    ("<day-of-month> (ordinal)October", -5.955837369464831),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.262690188904886),
                                    ("<time-of-day> am|pmintersect", -4.703074400969463),
                                    ("Octoberyear (latent)", -5.955837369464831),
                                    ("until <time>on <day>", -5.262690188904886),
                                    ("time-of-day (latent)intersect", -5.955837369464831),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.262690188904886),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.955837369464831),
                                    ("hh:mmon <day>", -3.5134903340956267),
                                    ("absorption of , after named dayJuly", -5.550372261356666),
                                    ("from|since|after <time>July", -5.955837369464831),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.039546637590676),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.550372261356666),
                                    ("hourmonth", -4.3463994570307305),
                                    ("todayat <time-of-day>", -5.955837369464831),
                                    ("Bank Holidayyear (latent)", -5.262690188904886),
                                    ("from|since|after <time>December", -5.955837369464831),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.955837369464831),
                                    ("<time-of-day> am|pmon <day>", -4.703074400969463),
                                    ("Mondayyear (latent)", -5.262690188904886),
                                    ("dayday", -4.56954300834494),
                                    ("dd/mmat <time-of-day>", -5.550372261356666),
                                    ("on <day>September", -5.550372261356666),
                                    ("time-of-day (latent)September", -5.550372261356666),
                                    ("hourhour", -5.039546637590676),
                                    ("time-of-day (latent)on <day>", -3.5134903340956267),
                                    ("Thursdaydd/mm", -5.955837369464831),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.550372261356666),
                                    ("dayyear", -2.9854229038951297),
                                    ("New Year's Dayyear (latent)", -5.550372261356666),
                                    ("Thursdayfrom|since|after <time>", -4.251089277226406),
                                    ("Thursdayat <time-of-day>", -4.3463994570307305),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.955837369464831),
                                    ("Aprilyear (latent)", -5.955837369464831),
                                    ("monthminute", -5.955837369464831),
                                    ("hourminute", -5.262690188904886),
                                    ("<time-of-day> am|pmtomorrow", -5.955837369464831),
                                    ("Thursdayhh:mm", -5.039546637590676),
                                    ("<day-of-month> (ordinal)Tuesday", -5.550372261356666),
                                    ("minutemonth", -4.164077900236776),
                                    ("minutehour", -5.955837369464831),
                                    ("Augustyear (latent)", -5.550372261356666),
                                    ("week-endin|during <named-month>|year", -5.955837369464831),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.955837369464831),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.550372261356666),
                                    ("Sundayyear (latent)", -5.039546637590676),
                                    ("Christmasat <time-of-day>", -5.955837369464831),
                                    ("from|since|after <time>year (latent)", -4.857225080796721),
                                    ("dd/mmyear (latent)", -5.955837369464831),
                                    ("<duration> after|before|from <time>December",
                                     -5.955837369464831),
                                    ("yesterday<time-of-day> am|pm", -5.955837369464831),
                                    ("<day-of-month> (ordinal)July", -5.955837369464831),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.955837369464831),
                                    ("at <time-of-day>intersect", -5.550372261356666),
                                    ("hh:mmyear (latent)", -3.876395827784995),
                                    ("Holiyear (latent)", -5.955837369464831),
                                    ("until <time><time-of-day> am|pm", -5.955837369464831),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.955837369464831),
                                    ("dayminute", -3.3908880120032943),
                                    ("yyyy-mm-ddhh:mm", -5.550372261356666),
                                    ("intersectSeptember", -4.451759972688556),
                                    ("minuteday", -2.7171589173004502),
                                    ("absorption of , after named dayintersect",
                                     -5.955837369464831),
                                    ("intersectyear (latent)", -5.955837369464831),
                                    ("Februaryin|during the <part-of-day>", -5.955837369464831),
                                    ("time-of-day (latent)July", -5.955837369464831),
                                    ("Saturdayyear (latent)", -5.955837369464831),
                                    ("at <time-of-day>on <day>", -5.550372261356666),
                                    ("time-of-day (latent)<time-of-day> am|pm", -5.955837369464831),
                                    ("absorption of , after named daySeptember",
                                     -5.039546637590676),
                                    ("Naraka Chaturdashiyear (latent)", -5.955837369464831),
                                    ("from|since|after <time>on <day>", -5.039546637590676),
                                    ("dayweek", -5.955837369464831),
                                    ("Easter Sundayyear (latent)", -5.550372261356666),
                                    ("time-of-day (latent)at <time-of-day>", -5.262690188904886),
                                    ("Thursday<time-of-day> am|pm", -4.703074400969463),
                                    ("weekyear", -5.550372261356666),
                                    ("time-of-day (latent)Thursday", -5.550372261356666),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.955837369464831),
                                    ("<day-of-month> (ordinal)April", -5.955837369464831),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.550372261356666),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.262690188904886),
                                    ("Sundayfrom|since|after <time>", -5.955837369464831),
                                    ("absorption of , after named dayFebruary", -5.039546637590676),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.955837369464831),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.955837369464831),
                                    ("tomorrowat <time-of-day>", -5.955837369464831),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.955837369464831),
                                    ("last <cycle> of <time>year (latent)", -5.550372261356666),
                                    ("tomorrow<time-of-day> am|pm", -5.955837369464831),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.262690188904886),
                                    ("Diwaliyear (latent)", -5.550372261356666),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.955837369464831),
                                    ("Fridayyear (latent)", -5.550372261356666),
                                    ("time-of-day (latent)April", -5.955837369464831),
                                    ("minuteyear", -3.7586127921286114)],
                               n = 258}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.208466836898277, unseen = -5.049856007249537,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.947881097378746e-2),
                                    ("intersect 2 numbers", -3.657130755799356)],
                               n = 151},
                   koData =
                     ClassData{prior = -1.6703986122237875,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
