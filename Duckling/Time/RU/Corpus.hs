...
allExamples = concat
  ...
  , examples (datetime (2013, 9, 9, 0, 0, 0) Day)
             [ "9 сентября 2013"
             , "09.09.13"
             , "09.09.2013"
             , "09 09"
  ...
  , examples (datetimeInterval ((2014, 1, 15, 9, 0, 0), (2014, 1, 16, 16, 31, 0)) Minute)
             [ "с 9:00 15 января до 16:30 16 января"
             ]
  ...
  , examples (datetime (20, 9, 9, 0, 0, 0) Day)
             [ "9 сентября 0020"
             , "09.09.0020"
             , "9 9 0020"
             , "09/09/0020"
  ...
  , examples (datetime (20, 9, 0, 0, 0, 0) Month)
             [ "09/0020"
             , "0020-09"
             ]
  , examples (datetime (15, 3, 3, 0, 0, 0) Day)
             [ "03.03.0015" ]
  , examples (datetime (18, 3, 3, 0, 0, 0) Day)
             [ "03.03.0018" ]
  , examples (datetime (20, 3, 3, 0, 0, 0) Day)
             [ "03.03.0020" ]
  ]
