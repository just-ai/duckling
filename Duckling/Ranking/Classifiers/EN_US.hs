...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6463633126807776,
                               unseen = -5.8944028342648505,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 361},
                   koData =
                     ClassData{prior = -0.7422276626295148, unseen = -5.799092654460526,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4794563600983456, unseen = -6.984716320118265,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.290642784698189),
                                    ("Father's Dayyear (latent)", -6.290642784698189),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.290642784698189),
                                    ("Ramadanyear (latent)", -6.290642784698189),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.275739764155925),
                                    ("Military Spouse Dayyear (latent)", -6.290642784698189),
                                    ("Bhai Doojyear (latent)", -6.290642784698189),
                                    ("hourday", -4.275739764155925), ("dayhour", -3.37287205261391),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.275739764155925),
                                    ("Martin Luther King's Dayyear (latent)", -5.8851776765900246),
                                    ("Shemini Atzeretyear (latent)", -6.290642784698189),
                                    ("daymonth", -4.681204872264089),
                                    ("monthday", -5.8851776765900246),
                                    ("monthyear", -4.498883315470135),
                                    ("Yom Ha'atzmautyear (latent)", -6.290642784698189),
                                    ("Vijayadashamiyear (latent)", -6.290642784698189),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -4.904348423578298),
                                    ("Thanksgiving Dayyear (latent)", -5.19203049603008),
                                    ("Thai Pongalyear (latent)", -5.597495604138244),
                                    ("Thiru Onamyear (latent)", -5.597495604138244),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.290642784698189),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.290642784698189),
                                    ("<day-of-month> (ordinal)Wednesday", -6.290642784698189),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.290642784698189),
                                    ("houryear", -5.374352052824034),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.290642784698189),
                                    ("Christmas<time-of-day> am|pm", -6.290642784698189),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.290642784698189),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.597495604138244),
                                    ("intersectin|during <named-month>|year", -6.290642784698189),
                                    ("<time-of-day> am|pmintersect", -5.037879816202821),
                                    ("Earth Houryear (latent)", -6.290642784698189),
                                    ("Octoberyear (latent)", -4.786565387921915),
                                    ("intersect<time-of-day> am|pm", -6.290642784698189),
                                    ("Mattu Pongalyear (latent)", -6.290642784698189),
                                    ("Daylight Saving Start Dayyear (latent)", -5.374352052824034),
                                    ("Shavuotyear (latent)", -6.290642784698189),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.290642784698189),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.290642784698189),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.8851776765900246),
                                    ("Marchyear (latent)", -6.290642784698189),
                                    ("Sukkotyear (latent)", -5.8851776765900246),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.8851776765900246),
                                    ("Daylight Saving End Dayyear (latent)", -5.374352052824034),
                                    ("Clean Mondayyear (latent)", -5.8851776765900246),
                                    ("monthhour", -5.8851776765900246),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.597495604138244),
                                    ("todayat <time-of-day>", -6.290642784698189),
                                    ("Thursday<time> timezone", -4.344732635642876),
                                    ("time-of-day (latent)tonight", -5.8851776765900246),
                                    ("from|since|after <time>December", -6.290642784698189),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.290642784698189),
                                    ("<time-of-day> am|pmon <day>", -4.275739764155925),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.290642784698189),
                                    ("yyyy-mm-ddhh:mm:ss", -5.8851776765900246),
                                    ("Tax Daythis|last|next <cycle>", -6.290642784698189),
                                    ("dayday", -3.848295749328985),
                                    ("<time> <part-of-day>at <time-of-day>", -6.290642784698189),
                                    ("mm/ddat <time-of-day>", -6.290642784698189),
                                    ("tonightat <time-of-day>", -6.290642784698189),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.597495604138244),
                                    ("today<time-of-day> am|pm", -6.290642784698189),
                                    ("Februarythe <day-of-month> (ordinal)", -5.8851776765900246),
                                    ("at <time-of-day><time> <part-of-day>", -6.290642784698189),
                                    ("<day-of-month> (ordinal)intersect", -5.8851776765900246),
                                    ("mm/dd<time-of-day> am|pm", -6.290642784698189),
                                    ("hourhour", -4.211201243018353),
                                    ("Navaratriin|during <named-month>|year", -6.290642784698189),
                                    ("Wednesdaythis|last|next <cycle>", -6.290642784698189),
                                    ("Lentyear (latent)", -6.290642784698189),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.786565387921915),
                                    ("Boghiyear (latent)", -6.290642784698189),
                                    ("dayyear", -1.9533520438656993),
                                    ("Thursdayfrom|since|after <time>", -5.8851776765900246),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.290642784698189),
                                    ("Thursdayat <time-of-day>", -5.597495604138244),
                                    ("Islamic New Yearyear (latent)", -5.8851776765900246),
                                    ("Laylat al-Qadryear (latent)", -5.374352052824034),
                                    ("Shrove Tuesdayyear (latent)", -6.290642784698189),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.597495604138244),
                                    ("<time-of-day> am|pmtomorrow", -5.597495604138244),
                                    ("Yom Kippuryear (latent)", -6.290642784698189),
                                    ("<day-of-month> (ordinal)Tuesday", -5.8851776765900246),
                                    ("<part-of-day> of <time>year (latent)", -6.290642784698189),
                                    ("minutehour", -5.19203049603008),
                                    ("Kaanum Pongalyear (latent)", -5.8851776765900246),
                                    ("Maha Saptamiyear (latent)", -6.290642784698189),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.8851776765900246),
                                    ("time-of-day (latent)tomorrow", -5.374352052824034),
                                    ("part of daysat <time-of-day>", -5.8851776765900246),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.585894692459764),
                                    ("for <duration> from <time>December", -6.290642784698189),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.290642784698189),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.037879816202821),
                                    ("time-of-day (latent)this <part-of-day>", -6.290642784698189),
                                    ("Pentecostyear (latent)", -6.290642784698189),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.037879816202821),
                                    ("<day-of-month> (ordinal)February", -6.290642784698189),
                                    ("Eid al-Fitryear (latent)", -6.290642784698189),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.290642784698189),
                                    ("Mondayin|during the <part-of-day>", -6.290642784698189),
                                    ("Chhathin|during <named-month>|year", -6.290642784698189),
                                    ("Diwaliin|during <named-month>|year", -6.290642784698189),
                                    ("Vaisakhiin|during <named-month>|year", -6.290642784698189),
                                    ("Raksha Bandhanyear (latent)", -6.290642784698189),
                                    ("daysecond", -5.8851776765900246),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.8851776765900246),
                                    ("Emancipation Dayyear (latent)", -5.597495604138244),
                                    ("Ashurayear (latent)", -6.290642784698189),
                                    ("Tuesdayin|during <named-month>|year", -6.290642784698189),
                                    ("Chinese New Yearyear (latent)", -6.290642784698189),
                                    ("tomorrowintersect", -6.290642784698189),
                                    ("Lag BaOmeryear (latent)", -6.290642784698189),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.290642784698189),
                                    ("Eid al-Adhayear (latent)", -5.374352052824034),
                                    ("intersectin|during the <part-of-day>", -6.290642784698189),
                                    ("Palm Sundayyear (latent)", -6.290642784698189),
                                    ("Christmasat <time-of-day>", -6.290642784698189),
                                    ("Passoveryear (latent)", -6.290642784698189),
                                    ("Lazarus Saturdayyear (latent)", -6.290642784698189),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.290642784698189),
                                    ("Cyber Mondayyear (latent)", -5.8851776765900246),
                                    ("Yom HaShoahyear (latent)", -5.8851776765900246),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.8851776765900246),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.290642784698189),
                                    ("Septemberyear (latent)", -5.8851776765900246),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.786565387921915),
                                    ("Halloweenyear (latent)", -6.290642784698189),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.290642784698189),
                                    ("at <time-of-day>intersect", -5.8851776765900246),
                                    ("Rosh Hashanahyear (latent)", -5.597495604138244),
                                    ("Dhanterasyear (latent)", -6.290642784698189),
                                    ("Tu BiShvatyear (latent)", -6.290642784698189),
                                    ("<day-of-month> (ordinal)December", -5.597495604138244),
                                    ("Holiyear (latent)", -5.597495604138244),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.290642784698189),
                                    ("Holika Dahanyear (latent)", -5.597495604138244),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.290642784698189),
                                    ("dayminute", -3.37287205261391),
                                    ("Mawlidyear (latent)", -6.290642784698189),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.8851776765900246),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.290642784698189),
                                    ("Jumu'atul-Widayear (latent)", -5.374352052824034),
                                    ("minuteday", -2.462001388209094),
                                    ("absorption of , after named dayintersect",
                                     -6.290642784698189),
                                    ("intersectyear (latent)", -6.290642784698189),
                                    ("Orthodox Easter Sundayyear (latent)", -6.290642784698189),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.290642784698189),
                                    ("Boss's Dayyear (latent)", -5.8851776765900246),
                                    ("Global Youth Service Dayyear (latent)", -6.290642784698189),
                                    ("Dhanterasin|during <named-month>|year", -6.290642784698189),
                                    ("Tisha B'Avyear (latent)", -6.290642784698189),
                                    ("Isra and Mi'rajyear (latent)", -5.374352052824034),
                                    ("at <time-of-day>on <day>", -5.19203049603008),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.290642784698189),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.597495604138244),
                                    ("Christmasyear (latent)", -5.8851776765900246),
                                    ("Naraka Chaturdashiyear (latent)", -5.8851776765900246),
                                    ("Thai Pongalin|during <named-month>|year", -6.290642784698189),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.290642784698189),
                                    ("dayweek", -6.290642784698189),
                                    ("Easter Sundayyear (latent)", -5.597495604138244),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.681204872264089),
                                    ("weekyear", -5.19203049603008),
                                    ("hh:mmin|during the <part-of-day>", -5.597495604138244),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.8851776765900246),
                                    ("Hanukkahyear (latent)", -5.597495604138244),
                                    ("February<time> <part-of-day>", -6.290642784698189),
                                    ("National Grandparents Dayyear (latent)", -6.290642784698189),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.290642784698189),
                                    ("Great Lentyear (latent)", -6.290642784698189),
                                    ("tomorrowat <time-of-day>", -5.597495604138244),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.290642784698189),
                                    ("Labor Dayyear (latent)", -6.290642784698189),
                                    ("Vaisakhiyear (latent)", -5.597495604138244),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.290642784698189),
                                    ("last <cycle> of <time>year (latent)", -5.597495604138244),
                                    ("at <time-of-day>tomorrow", -5.8851776765900246),
                                    ("tomorrow<time-of-day> am|pm", -6.290642784698189),
                                    ("President's Dayyear (latent)", -6.290642784698189),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.290642784698189),
                                    ("Diwaliyear (latent)", -6.290642784698189),
                                    ("between <time> and <time>on <day>", -4.681204872264089),
                                    ("Black Fridayyear (latent)", -5.8851776765900246),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.290642784698189),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.290642784698189),
                                    ("Chhathyear (latent)", -5.8851776765900246),
                                    ("Vasant Panchamiyear (latent)", -6.290642784698189),
                                    ("Tax Dayyear (latent)", -5.374352052824034),
                                    ("St Patrick's Dayyear (latent)", -6.290642784698189),
                                    ("Thursday<time> (timezone)", -6.290642784698189),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.290642784698189),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.8851776765900246),
                                    ("Februaryintersect", -6.290642784698189),
                                    ("Mother's Dayyear (latent)", -6.290642784698189),
                                    ("Simchat Torahyear (latent)", -6.290642784698189),
                                    ("minuteyear", -6.290642784698189)],
                               n = 408},
                   koData =
                     ClassData{prior = -0.9652705953707232, unseen = -6.641182169740591,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.17950861541734, unseen = -5.209486152841421,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.352269203864356e-2),
                                    ("intersect 2 numbers", -3.817712325956905)],
                               n = 178},
                   koData =
                     ClassData{prior = -1.8059441042200113,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
