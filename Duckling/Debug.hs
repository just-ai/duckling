...
rum x = debug (makeLocale RU $ Nothing) x [This AmountOfMoney]
rutg x = debug (makeLocale RU $ Nothing) x [This TimeGrain]
...
enm x = debug (makeLocale EN $ Just US) x [This AmountOfMoney]
