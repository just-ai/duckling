...
ruleOrdinal = Rule
  ...
  , pattern =
    ...
    , regex "(перв|втор|трет|четв[её]рт|пят|шест|седьм|восьм|девят)(ь(е(му?|го|й)?|и(ми?|х|)|ю)|ого|ому|ый|ой|ий|ая|ое|ья|ые|ыми?|ых|ую|ом)"
    ]
  , prod = \tokens -> case tokens of
