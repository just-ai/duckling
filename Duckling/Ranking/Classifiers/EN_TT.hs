...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6567795363890705, unseen = -5.780743515792329,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 322},
                   koData =
                     ClassData{prior = -0.7308875085427924, unseen = -5.707110264748875,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5086493443433951, unseen = -6.887552571664617,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.193384461970565),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.193384461970565),
                                    ("Ramadanyear (latent)", -6.193384461970565),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -4.178481441428301),
                                    ("Bhai Doojyear (latent)", -6.193384461970565),
                                    ("hourday", -4.178481441428301),
                                    ("dayhour", -3.275613729886286),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.178481441428301),
                                    ("Martin Luther King's Dayyear (latent)", -5.7879193538624),
                                    ("Shemini Atzeretyear (latent)", -6.193384461970565),
                                    ("daymonth", -4.583946549536464),
                                    ("monthday", -5.7879193538624),
                                    ("monthyear", -4.40162499274251),
                                    ("Yom Ha'atzmautyear (latent)", -6.193384461970565),
                                    ("Vijayadashamiyear (latent)", -6.193384461970565),
                                    ("Thai Pongalyear (latent)", -5.5002372814106195),
                                    ("Thiru Onamyear (latent)", -5.5002372814106195),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.193384461970565),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.193384461970565),
                                    ("<day-of-month> (ordinal)Wednesday", -6.193384461970565),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.193384461970565),
                                    ("houryear", -5.27709373009641),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.193384461970565),
                                    ("Christmas<time-of-day> am|pm", -6.193384461970565),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.193384461970565),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5002372814106195),
                                    ("intersectin|during <named-month>|year", -6.193384461970565),
                                    ("<time-of-day> am|pmintersect", -4.940621493475197),
                                    ("Earth Houryear (latent)", -6.193384461970565),
                                    ("Octoberyear (latent)", -4.689307065194291),
                                    ("intersect<time-of-day> am|pm", -6.193384461970565),
                                    ("Mattu Pongalyear (latent)", -6.193384461970565),
                                    ("Shavuotyear (latent)", -6.193384461970565),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.193384461970565),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.193384461970565),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.7879193538624),
                                    ("Marchyear (latent)", -6.193384461970565),
                                    ("Sukkotyear (latent)", -5.7879193538624),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.7879193538624),
                                    ("Clean Mondayyear (latent)", -5.7879193538624),
                                    ("monthhour", -5.7879193538624),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5002372814106195),
                                    ("todayat <time-of-day>", -6.193384461970565),
                                    ("Thursday<time> timezone", -4.2474743129152515),
                                    ("time-of-day (latent)tonight", -5.7879193538624),
                                    ("from|since|after <time>December", -6.193384461970565),
                                    ("<time-of-day> am|pmon <day>", -4.178481441428301),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.193384461970565),
                                    ("yyyy-mm-ddhh:mm:ss", -5.7879193538624),
                                    ("dayday", -3.7510374266013606),
                                    ("<time> <part-of-day>at <time-of-day>", -6.193384461970565),
                                    ("tonightat <time-of-day>", -6.193384461970565),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.5002372814106195),
                                    ("today<time-of-day> am|pm", -6.193384461970565),
                                    ("Februarythe <day-of-month> (ordinal)", -5.7879193538624),
                                    ("at <time-of-day><time> <part-of-day>", -6.193384461970565),
                                    ("<day-of-month> (ordinal)intersect", -5.7879193538624),
                                    ("hourhour", -4.113942920290729),
                                    ("Navaratriin|during <named-month>|year", -6.193384461970565),
                                    ("Wednesdaythis|last|next <cycle>", -6.193384461970565),
                                    ("Lentyear (latent)", -6.193384461970565),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.689307065194291),
                                    ("Boghiyear (latent)", -6.193384461970565),
                                    ("dayyear", -2.1415995141672606),
                                    ("Thursdayfrom|since|after <time>", -5.7879193538624),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.193384461970565),
                                    ("Thursdayat <time-of-day>", -5.5002372814106195),
                                    ("Islamic New Yearyear (latent)", -5.7879193538624),
                                    ("Laylat al-Qadryear (latent)", -5.27709373009641),
                                    ("Shrove Tuesdayyear (latent)", -6.193384461970565),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.5002372814106195),
                                    ("<time-of-day> am|pmtomorrow", -5.5002372814106195),
                                    ("Yom Kippuryear (latent)", -6.193384461970565),
                                    ("<day-of-month> (ordinal)Tuesday", -5.7879193538624),
                                    ("<part-of-day> of <time>year (latent)", -6.193384461970565),
                                    ("minutehour", -5.094772173302456),
                                    ("Kaanum Pongalyear (latent)", -5.7879193538624),
                                    ("Maha Saptamiyear (latent)", -6.193384461970565),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.7879193538624),
                                    ("time-of-day (latent)tomorrow", -5.27709373009641),
                                    ("part of daysat <time-of-day>", -5.7879193538624),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.48863636973214),
                                    ("for <duration> from <time>December", -6.193384461970565),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.193384461970565),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.940621493475197),
                                    ("time-of-day (latent)this <part-of-day>", -6.193384461970565),
                                    ("Pentecostyear (latent)", -6.193384461970565),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.940621493475197),
                                    ("<day-of-month> (ordinal)February", -6.193384461970565),
                                    ("Eid al-Fitryear (latent)", -6.193384461970565),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.193384461970565),
                                    ("Mondayin|during the <part-of-day>", -6.193384461970565),
                                    ("Chhathin|during <named-month>|year", -6.193384461970565),
                                    ("Diwaliin|during <named-month>|year", -6.193384461970565),
                                    ("Vaisakhiin|during <named-month>|year", -6.193384461970565),
                                    ("Raksha Bandhanyear (latent)", -6.193384461970565),
                                    ("daysecond", -5.7879193538624),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.7879193538624),
                                    ("Ashurayear (latent)", -6.193384461970565),
                                    ("Tuesdayin|during <named-month>|year", -6.193384461970565),
                                    ("Chinese New Yearyear (latent)", -6.193384461970565),
                                    ("tomorrowintersect", -6.193384461970565),
                                    ("Lag BaOmeryear (latent)", -6.193384461970565),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.193384461970565),
                                    ("Eid al-Adhayear (latent)", -5.27709373009641),
                                    ("intersectin|during the <part-of-day>", -6.193384461970565),
                                    ("Palm Sundayyear (latent)", -6.193384461970565),
                                    ("Christmasat <time-of-day>", -6.193384461970565),
                                    ("Passoveryear (latent)", -6.193384461970565),
                                    ("Lazarus Saturdayyear (latent)", -6.193384461970565),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.193384461970565),
                                    ("Yom HaShoahyear (latent)", -5.7879193538624),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -5.7879193538624),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.193384461970565),
                                    ("Septemberyear (latent)", -5.7879193538624),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.689307065194291),
                                    ("Halloweenyear (latent)", -6.193384461970565),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.193384461970565),
                                    ("at <time-of-day>intersect", -5.7879193538624),
                                    ("Rosh Hashanahyear (latent)", -5.5002372814106195),
                                    ("Dhanterasyear (latent)", -6.193384461970565),
                                    ("Tu BiShvatyear (latent)", -6.193384461970565),
                                    ("<day-of-month> (ordinal)December", -5.5002372814106195),
                                    ("Holiyear (latent)", -5.5002372814106195),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.193384461970565),
                                    ("Holika Dahanyear (latent)", -5.5002372814106195),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.193384461970565),
                                    ("dayminute", -3.331183581041097),
                                    ("Mawlidyear (latent)", -6.193384461970565),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.7879193538624),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.193384461970565),
                                    ("Jumu'atul-Widayear (latent)", -5.27709373009641),
                                    ("minuteday", -2.36474306548147),
                                    ("absorption of , after named dayintersect",
                                     -6.193384461970565),
                                    ("intersectyear (latent)", -6.193384461970565),
                                    ("Orthodox Easter Sundayyear (latent)", -6.193384461970565),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.193384461970565),
                                    ("Boss's Dayyear (latent)", -5.7879193538624),
                                    ("Global Youth Service Dayyear (latent)", -6.193384461970565),
                                    ("Dhanterasin|during <named-month>|year", -6.193384461970565),
                                    ("Tisha B'Avyear (latent)", -6.193384461970565),
                                    ("Isra and Mi'rajyear (latent)", -5.27709373009641),
                                    ("at <time-of-day>on <day>", -5.094772173302456),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.193384461970565),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.5002372814106195),
                                    ("Christmasyear (latent)", -5.7879193538624),
                                    ("Naraka Chaturdashiyear (latent)", -5.7879193538624),
                                    ("Thai Pongalin|during <named-month>|year", -6.193384461970565),
                                    ("dayweek", -6.193384461970565),
                                    ("Easter Sundayyear (latent)", -5.5002372814106195),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -4.583946549536464),
                                    ("weekyear", -5.094772173302456),
                                    ("hh:mmin|during the <part-of-day>", -5.5002372814106195),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.7879193538624),
                                    ("Hanukkahyear (latent)", -5.5002372814106195),
                                    ("February<time> <part-of-day>", -6.193384461970565),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -6.193384461970565),
                                    ("Great Lentyear (latent)", -6.193384461970565),
                                    ("tomorrowat <time-of-day>", -5.5002372814106195),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.193384461970565),
                                    ("Vaisakhiyear (latent)", -5.5002372814106195),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -6.193384461970565),
                                    ("last <cycle> of <time>year (latent)", -5.5002372814106195),
                                    ("at <time-of-day>tomorrow", -5.7879193538624),
                                    ("tomorrow<time-of-day> am|pm", -6.193384461970565),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.193384461970565),
                                    ("Diwaliyear (latent)", -6.193384461970565),
                                    ("between <time> and <time>on <day>", -4.583946549536464),
                                    ("Black Fridayyear (latent)", -5.7879193538624),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.193384461970565),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.193384461970565),
                                    ("Chhathyear (latent)", -5.7879193538624),
                                    ("Vasant Panchamiyear (latent)", -6.193384461970565),
                                    ("St Patrick's Dayyear (latent)", -6.193384461970565),
                                    ("Thursday<time> (timezone)", -6.193384461970565),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.193384461970565),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.7879193538624),
                                    ("Februaryintersect", -6.193384461970565),
                                    ("Simchat Torahyear (latent)", -6.193384461970565),
                                    ("minuteyear", -6.193384461970565)],
                               n = 368},
                   koData =
                     ClassData{prior = -0.9195640572191242, unseen = -6.595780513961311,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -3.193216078087623),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -5.901266279189834),
                                    ("<day-of-month> (ordinal)August", -5.901266279189834),
                                    ("dayhour", -3.3363169217282964),
                                    ("<time> timezoneyear (latent)", -5.901266279189834),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.9849755473156785),
                                    ("Tuesdayfrom|since|after <time>", -5.901266279189834),
                                    ("daymonth", -3.649974480583338),
                                    ("monthyear", -4.6485033106944655),
                                    ("<time-of-day> am|pmyear (latent)", -5.208119098629888),
                                    ("Thai Pongalyear (latent)", -5.208119098629888),
                                    ("intersecthh:mm", -5.901266279189834),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.901266279189834),
                                    ("<day-of-month> (ordinal)Wednesday", -5.901266279189834),
                                    ("houryear", -4.514971918069943),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.901266279189834),
                                    ("<day-of-month> (ordinal)October", -5.901266279189834),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.208119098629888),
                                    ("<time-of-day> am|pmintersect", -4.6485033106944655),
                                    ("Octoberyear (latent)", -5.901266279189834),
                                    ("until <time>on <day>", -5.208119098629888),
                                    ("time-of-day (latent)intersect", -5.901266279189834),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.208119098629888),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.901266279189834),
                                    ("hh:mmon <day>", -3.458919243820629),
                                    ("absorption of , after named dayJuly", -5.495801171081669),
                                    ("from|since|after <time>July", -5.901266279189834),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.9849755473156785),
                                    ("Clean Mondayyear (latent)", -5.901266279189834),
                                    ("monthhour", -5.901266279189834),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.495801171081669),
                                    ("hourmonth", -4.291828366755733),
                                    ("todayat <time-of-day>", -5.901266279189834),
                                    ("from|since|after <time>December", -5.901266279189834),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.901266279189834),
                                    ("<time-of-day> am|pmon <day>", -4.6485033106944655),
                                    ("Mondayyear (latent)", -5.208119098629888),
                                    ("dayday", -4.514971918069943),
                                    ("on <day>September", -5.495801171081669),
                                    ("time-of-day (latent)September", -5.495801171081669),
                                    ("hourhour", -5.901266279189834),
                                    ("time-of-day (latent)on <day>", -3.458919243820629),
                                    ("Thursdaydd/mm", -5.901266279189834),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.495801171081669),
                                    ("dayyear", -3.039065398260365),
                                    ("New Year's Dayyear (latent)", -5.495801171081669),
                                    ("Thursdayfrom|since|after <time>", -4.196518186951408),
                                    ("Thursdayat <time-of-day>", -4.291828366755733),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.901266279189834),
                                    ("Aprilyear (latent)", -5.901266279189834),
                                    ("monthminute", -5.901266279189834),
                                    ("<time-of-day> am|pmtomorrow", -5.901266279189834),
                                    ("Thursdayhh:mm", -4.9849755473156785),
                                    ("<day-of-month> (ordinal)Tuesday", -5.495801171081669),
                                    ("minutemonth", -4.109506809961778),
                                    ("minutehour", -5.901266279189834),
                                    ("Augustyear (latent)", -5.495801171081669),
                                    ("week-endin|during <named-month>|year", -5.901266279189834),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.901266279189834),
                                    ("Sundayyear (latent)", -4.9849755473156785),
                                    ("Christmasat <time-of-day>", -5.901266279189834),
                                    ("from|since|after <time>year (latent)", -4.802653990521724),
                                    ("<duration> after|before|from <time>December",
                                     -5.901266279189834),
                                    ("yesterday<time-of-day> am|pm", -5.901266279189834),
                                    ("<day-of-month> (ordinal)July", -5.901266279189834),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.901266279189834),
                                    ("at <time-of-day>intersect", -5.495801171081669),
                                    ("hh:mmyear (latent)", -3.8218247375099974),
                                    ("Holiyear (latent)", -5.901266279189834),
                                    ("until <time><time-of-day> am|pm", -5.901266279189834),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.901266279189834),
                                    ("dayminute", -3.375537634881578),
                                    ("yyyy-mm-ddhh:mm", -5.495801171081669),
                                    ("intersectSeptember", -4.397188882413559),
                                    ("minuteday", -2.662587827025453),
                                    ("absorption of , after named dayintersect",
                                     -5.901266279189834),
                                    ("intersectyear (latent)", -5.901266279189834),
                                    ("Februaryin|during the <part-of-day>", -5.901266279189834),
                                    ("time-of-day (latent)July", -5.901266279189834),
                                    ("Saturdayyear (latent)", -5.901266279189834),
                                    ("at <time-of-day>on <day>", -5.495801171081669),
                                    ("absorption of , after named daySeptember",
                                     -4.9849755473156785),
                                    ("Naraka Chaturdashiyear (latent)", -5.901266279189834),
                                    ("from|since|after <time>on <day>", -4.9849755473156785),
                                    ("dayweek", -5.901266279189834),
                                    ("Easter Sundayyear (latent)", -5.495801171081669),
                                    ("Thursday<time-of-day> am|pm", -4.6485033106944655),
                                    ("weekyear", -5.495801171081669),
                                    ("time-of-day (latent)Thursday", -5.495801171081669),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.901266279189834),
                                    ("<day-of-month> (ordinal)April", -5.901266279189834),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.495801171081669),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.208119098629888),
                                    ("Sundayfrom|since|after <time>", -5.901266279189834),
                                    ...
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.901266279189834),
                                    ("tomorrowat <time-of-day>", -5.901266279189834),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.901266279189834),
                                    ("last <cycle> of <time>year (latent)", -5.495801171081669),
                                    ("tomorrow<time-of-day> am|pm", -5.901266279189834),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.208119098629888),
                                    ("Diwaliyear (latent)", -5.495801171081669),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.901266279189834),
                                    ("Fridayyear (latent)", -5.495801171081669),
                                    ("time-of-day (latent)April", -5.901266279189834),
                                    ("minuteyear", -3.704041701853614)],
                               n = 244}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.2174128766052247, unseen = -4.976733742420574,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 140},
                   koData =
                     ClassData{prior = -1.6326947745983675,
